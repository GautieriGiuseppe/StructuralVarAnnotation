...
#SBATCH --job-name=snakemake_annotation_variant_calling
...
snakemake --snakefile annotation_master.smk --configfile config.yml --unlock

# 4. Run Snakemake

snakemake \
     --snakefile annotation_master.smk \
